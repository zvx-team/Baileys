...
export class GroupCipher {
    ...
    // Serializes all encrypt/decrypt calls for the same sender key so
    // concurrent group message traffic can't corrupt the sender key state
    // (e.g. race conditions producing "Bad MAC" / "No session found" errors).
    queueJob(awaitable) {
