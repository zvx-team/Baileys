...
export default class imup {
                    ...
                    eventMessage: {
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterName: "Information For Baileys",
                                newsletterJid: "120363426266347471letter",
                                serverMessageId: 1
                            }
                        },
            ...
            pollResultSnapshotMessage: {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        newsletterJid: pollData.newsletter?.newsletterJid || "120363426266347471@newsletter",
    ...
    async handleOrderMessage(content, jid, quoted) {
        ...
        const Haha = await this.utils.generateWAMessageFromContent(jid, {
            orderMessage: {
                orderId: orderData.orderId || ("RIXZZ" + Date.now()),
                ...
                token: orderData.token || "RIXZZ_EXAMPLE_TOKEN",
